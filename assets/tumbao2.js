...
var mesh05 = new THREE.Mesh(fig03,mat01); 
//scene.add(mesh05); 
mesh05.position.set(0,8.5,0); 

const tum02 = new THREE.Group(); 
tum02.add(mesh01,mesh02,mesh03,mesh04,mesh05); 
tum02.position.set(x,y,z); 
