...
var txtimg = new THREE.MeshBasicMaterial({
    color: 0xE8924D , side:THREE.DoubleSide
...
const Ppcado05 = new THREE.Group(); 
Ppcado05.add(mesh01, Volane, VOlane02,mesh09, mesh10, mesh11, mesh12, mesh13, petalo, petalo02, petalo03, petalo04); 
Ppcado05.position.set(x,y,z); 
