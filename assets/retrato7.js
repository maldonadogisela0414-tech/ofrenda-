...
// Agregar plano 
 ...
 var texture = new THREE.TextureLoader().load ("./assets/pedroInfante.png")
...
var texture = new THREE.TextureLoader().load("./assets/PR07.jpg")
var material01 =new THREE.MeshLambertMaterial(
    {
        map:texture
    }
...
const RPedro07 = new THREE.Group(); 
RPedro07.add(mesh03,mesh04,mesh02,mesh05,mesh06,mesh07); 
RPedro07.position.set(x,y,z); 
