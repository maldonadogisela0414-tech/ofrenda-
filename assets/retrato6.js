...
// Agregar plano 
 ...
 var texture = new THREE.TextureLoader().load ("./assets/PR06.jpg")
...
const RPedro06 = new THREE.Group(); 
RPedro06.add(mesh03,mesh04,mesh02,mesh05,mesh06,mesh07); 
RPedro06.position.set(x,y,z); 
