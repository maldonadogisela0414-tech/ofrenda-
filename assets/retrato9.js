...
// Agregar plano 
 ...
 var texture = new THREE.TextureLoader().load ("./assets/PR09.jpg")
...
const RPedro09 = new THREE.Group(); 
RPedro09.add(mesh03,mesh04,mesh02,mesh05,mesh06,mesh07); 
RPedro09.position.set(x,y,z); 
