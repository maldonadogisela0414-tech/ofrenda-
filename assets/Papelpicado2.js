...
var txtimg = new THREE.MeshBasicMaterial({
    color: 66944925 , side:THREE.DoubleSide
...
const Ppcado02 = new THREE.Group(); 
Ppcado02.add(mesh01, Volane, VOlane02,mesh09, mesh10, mesh11, mesh12, mesh13, petalo, petalo02, petalo03, petalo04); 
Ppcado02.position.set(x,y,z); 
