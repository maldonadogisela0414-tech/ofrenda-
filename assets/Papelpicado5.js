...
var txtimg = new THREE.MeshBasicMaterial({
    color: 0xF2EF5C , side:THREE.DoubleSide
...
    color:459259, side: THREE.DoubleSide
}); 
...
const Ppcado04 = new THREE.Group(); 
Ppcado04.add(mesh01, Volane, VOlane02,mesh09, mesh10, mesh11, mesh12, mesh13, petalo, petalo02, petalo03, petalo04); 
Ppcado04.position.set(x,y,z); 
