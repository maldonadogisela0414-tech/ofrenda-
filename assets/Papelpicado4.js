...
//scene.add(mesh14); 
mesh14.scale.set(0.15,.05,.01);
mesh14.position.set(4,4,0);
mesh14.rotation.set(0,0,.8);

var mesh15 = new THREE.Mesh(fig04,mat02); 
//scene.add(mesh15); 
mesh15.scale.set(0.15,.05,.01);
mesh15.position.set(6,6,0);
mesh15.rotation.set(0,0,.8);

var petalo =new  THREE.Group();
petalo.add(mesh14,mesh15); 
//scene.add(petalo); 

var petalo02 = petalo.clone(); 
petalo02.position.set(9.9,-.1,0);
petalo02.rotation.set(0,0,1.53073);
//scene.add(petalo02); 
...
mesh18.position.set(3,5,0);

var mesh19 = new THREE.Mesh(fig04,mat02); 
//scene.add(mesh19); 
mesh19.scale.set(0.025,.025,.01);
mesh19.position.set(7,5,0);

var mesh20 = new THREE.Mesh(fig04,mat02); 
//scene.add(mesh20); 
mesh20.scale.set(0.025,.025,.01);
mesh20.position.set(5,3,0);

var mesh21 = new THREE.Mesh(fig04,mat02); 
//scene.add(mesh21); 
mesh21.scale.set(0.025,.025,.01);
mesh21.position.set(5,7,0);

const Papic03 = new THREE.Group(); 
Papic03.add(mesh01,Volane,VOlane02,VOlane03,mesh06,mesh07,mesh08,mesh09,mesh10,mesh11,mesh12,mesh13,mesh14,mesh15,mesh18,mesh19,mesh20,mesh21,petalo,petalo02); 
Papic03.position.set(x,y,z); 
