...
// Agregar plano 
 ...
 var texture = new THREE.TextureLoader().load ("./assets/PR08.jpg")
...
const RPedro08 = new THREE.Group(); 
RPedro08.add(mesh03,mesh04,mesh02,mesh05,mesh06,mesh07); 
RPedro08.position.set(x,y,z); 
