...
// Agregar plano 
 ...
 var texture = new THREE.TextureLoader().load ("./assets/PR05.jpg")
...
const RPedro05 = new THREE.Group(); 
RPedro05.add(mesh03,mesh04,mesh02,mesh05,mesh06,mesh07); 
RPedro05.position.set(x,y,z); 
