...
var texture = new THREE.TextureLoader().load("./assets/PR02.png")
...
const RPedro02 = new THREE.Group(); 
RPedro02.add(mesh03,mesh04,mesh02,mesh05,mesh06,mesh07); 
RPedro02.position.set(x,y,z); 
