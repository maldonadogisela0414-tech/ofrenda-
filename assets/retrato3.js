...
var texture = new THREE.TextureLoader().load("./assets/PR03.jpg")
...
const RPedro03 = new THREE.Group(); 
RPedro03.add(mesh03,mesh04,mesh02,mesh05,mesh06,mesh07); 
RPedro03.position.set(x,y,z); 
